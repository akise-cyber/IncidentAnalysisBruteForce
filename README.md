...
Google Activity - Hardening OS, Incident Analysis (TCPdump) & Incident Report
...
1 - TCPdump to view the DNS/HTTP logs 

2 - Identify the network protocol invovled in the incident
